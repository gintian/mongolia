...
import './index.scss'
import { jdgk, lz1qgk, cglzq, yjc, nqbt, wqbt, rygk, khll, wjbt, tjbt,SPCount } from '../../api/mainApi'
...
        "supportNum": "22"   //后勤人员人数
    ...
    //     // "综合指挥楼","留置用房","武警执勤楼","后勤保障楼","9号办公楼","中心办公楼","特警执勤楼","体能训练馆"
    //      "留置用房","综合指挥楼"," 中心办公楼"," 9号办公楼","武警执勤楼","特警执勤楼","后勤保障楼","体能训练馆"
    // ])
    const [Floor, setFloor] = useState([
        "留置用房","综合指挥楼","中心办公楼","9号办公楼","武警执勤楼","特警执勤楼","后勤保障楼","体能训练馆"
    ])
            ...
            <div className="VillaList" style={{ color: "red" }}>
                ...
                <div className="VillaLeft">
                    ...
                    <div className="VillaOne">
                                ...
                                </div> */}
                        {
                            Object.keys(jdgkData).length > 0 ?
                                <div className="titlecenter">
                                    <p><span style={{ marginRight: "30px", marginTop: "12px" }}>占地</span><span style={{ position: 'relative', left: "20px", top: "12px" }}>建筑面积</span></p>
                                    <p style={{ marginTop: "36px" }}><span style={{ marginRight: "-25px", marginTop: -19 }}>{jdgkData.covers}<a href="##" style={{ fontSize: "14px" ,fontSize:"16px",color: "#2BFAFF",fontWeight: 700,marginLeft:"4px"}}>亩</a></span><span style={{ position: 'relative', left: "50px", top: "-18px" }}>{jdgkData.floor}<a href="##" style={{ fontSize: "14px" ,fontSize:"16px",color: "#2BFAFF",fontWeight: 700,marginLeft:"4px"}}>万平方米</a></span></p>
                                </div> : <div className="titlecenter">
                                    <p><span style={{ marginRight: "-20px", marginTop: "20px" }}>占地</span><span style={{ position: 'relative', left: "60px", top: "15px" }}>建筑面积</span></p>
                                    <p style={{ marginTop: "36px" }}><span style={{ marginRight: "-65px", marginTop: -18 }}>607亩</span><span style={{ position: 'relative', left: "80px", top: -25 }}>5.23<a href="##" style={{ fontSize: "14px" }}>万平方米</a></span></p>
                                </div>
                        }
                        <div className="titlebottom">
                            <p onClick={() => Moudle()}>《功能区介绍》</p>
                            ...
                            <ul>
                             
                               {
                                    Floor.map((item,index)=>{
                                        return(
                                         <li onClick={() => NMdw(index+1,item,index)} key={index} className={index===current && 'activelist'}>
                                         <i></i>
                                                 {item}
                                             </li>
                                        )
                                ...
                                Object.keys(rygkData).length > 0 ?
                                    <div className="twobackgrounde" id="box">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <i></i>
                                                {/* <p className="countNum center" style={{display:"none"}}>{rygkData.invesGroupPeopleNum}</p> */}
                                            </li>
                                        </ul>
                                        <div className="arraw">
                                            <a href="javascript:;" className="next" >1</a>
                                            <a href="javascript:;" className='prev'>0</a>
                                        </div>
                                        </div>
                                        {/* <p className="b1">
                                    ...
                                    <div className="twobackgrounde" id="box">
                                        ...
                                        <ul>
                                            <li>
                                                <p className="countNum">22</p>
                                                <i></i>
                                                <p className="person">后勤人数</p>
                                            </li>
                                            <li>
                                            <p className="countNum">22</p>
                                                <i></i>
                                                <p  className="person">医护人数</p>
                                            </li>
                                            <li>
                                            <p className="countNum">22</p>
                                                <i></i>
                                                <p  className="person">管理人数</p>
                                            </li>
                                            <li>
                                            <p className="countNum">22</p>
                                                <i></i>
                                                <p  className="person">看护人数</p>
                                            </li>
                                            <li>
                                                <p className="countNum">22</p>
                                                <i></i>
                                                <p  className="person"> 办案人员入驻</p>
                                            </li>
                                            <li>
                                                <i></i>
                                                <p className="countNum center">22</p>
                                            </li>
                                        </ul>
                                        <div className="arraw">
                                            <a href="javascript:;" className="next" >22</a>
                                            <a href="javascript:;" className='prev'>00</a>
                                        </div>
                                        </div>
                                    </div> 
                            }
                    ...
                    <div className="VillaThreeya">
                        ...
                        {
                               Object.keys(khllData).length > 0 ?  <div className="policelist">

                               <div><p><span>武警看护对象</span><span>{khllData.policeTotal}</span></p></div>
                               <div><p><span>特警看护对象</span><span>{khllData.swatTotal}</span></p></div>

                               <div><p><span>武警看护对象</span><span>{SPcount.swat}</span></p></div>
                               <div><p><span>特警看护对象</span><span>{SPcount.police}</span></p></div>

                            </div>:  <div className="policelist">
                         ...
                         <div className="picture">
                             <div><i></i></div>
                             <div className="icon1"><i ></i></div>
                         </div>
                         {
                               Object.keys(khllData).length > 0 ?<div className="nurse">
                               <div><p><span>医生</span><span>{khllData.doctor}<i>名</i></span></p><p><span>护士</span><span>{khllData.nurse}<i>名</i></span></p></div>
                               <div><p><span>救护车</span><span>{khllData.ambulance}<i>辆</i></span></p><p><span>急救设备</span><span>{khllData.equipment}<i>台</i></span></p></div>
                           </div>:<div className="nurse">
                               <div><p><span>医生</span><span>2<i>名</i></span></p><p><span>护士</span><span>1<i>名</i></span></p></div>
                               <div><p><span>救护车</span><span>2<i>辆</i></span></p><p><span>急救设备</span><span>1<i>台</i></span></p></div>
                           </div>
                         }
                        ...
                        {/* {
                            Object.keys(khllData).length > 0 ? <div className="police">
                                 <ul>
                                    <li>
                                        <p><span className="wj">武警</span><span style={{marginLeft:"20px",marginTop:"4px"}}>{khllData.policeTotal}</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">{khllData.swatTotal}</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">特警</span></p>
                                    </li>
                                    <li>
                                        <p><span className="wj">医生</span><span style={{marginLeft:"20px",marginTop:"4px"}}>{khllData.doctor}</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">{khllData.nurse}</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">护士</span></p>
                                    </li>
                                    <li>
                                        <p><span className="wj">救护车</span><span style={{marginLeft:"20px",marginTop:"4px"}}>{khllData.ambulance}</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">{khllData.equipment}</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">急救设备</span></p>
                                    </li>
                                </ul> */}
                                {/* <div><p><span className="wj">武警看护对象</span><span></span></p></div>
                                <div><p><span>特警看护对象</span><span></span></p></div> */}
                            {/* </div> : <div className="police"> */}
                                {/* <div><p><span className="wj">武警看护</span><span style={{marginLeft:"20px",marginTop:"4px"}}>24</span></p></div>
                                <div><p><span style={{fontSize:"25px",fontWeight:"700",marginTop:"-24px"}}>18</span><span className="tj">特警看护</span></p></div> */}
                                {/* <ul>
                                    <li>
                                        <p><span className="wj">武警看护</span><span style={{marginLeft:"20px",marginTop:"4px"}}>24</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">24</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">特警</span></p>
                                    </li>
                                    <li>
                                        <p><span className="wj">医生</span><span style={{marginLeft:"20px",marginTop:"4px"}}>24</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">24</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">护士</span></p>
                                    </li>
                                    <li>
                                        <p><span className="wj">救护车</span><span style={{marginLeft:"20px",marginTop:"4px"}}>10</span></p>
                                    </li>
                                    <li>
                                        <p><span className="tj">33</span><span style={{marginLeft:"20px",marginTop:"4px"}} className="wj">急救设备</span></p>
                                    </li>
                                </ul>
                            </div>
                        } */}
