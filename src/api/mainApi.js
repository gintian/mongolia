...
// 房屋内设备状态
export function roomDeviceStatus(paramsData) {
    return request({
        url: constant.roomDeviceStatus,
        method: 'post',
        data: paramsData
    })
}
 ...
 // 留置人员武警豁特警看护人数
 export function SPCount() {
     return request({
         url: constant.SPCount,
        method: 'get'
    })
 }
...
// // 安全风险评估
// export function DangerRisk() {
//     return request({
//         url: constant.DangerRisk,
//         method: 'get'
