...
const constant =  {
  ...
  SPCC_DoorList : `${doorUrl}/SPCC/DoorList`,
   ...
   // 风险评估 饼状图
   runSuationZX: `${datamanel}/detain/getDetainRiskPieInfo`,
   // 滞留预警
  ...
  // 房间设备的状态
  roomDeviceStatus:`${datamanel}/device/getRoomDeviceStatus`,
  // 安全风险评估
  // DangerRisk:`${datamanel}/detain/getDetainRiskPieInfo`,

  // 留置人员武警或特警看护人数
  SPCount:`${datamanel}/detain/getDetainCustodyNum`,
